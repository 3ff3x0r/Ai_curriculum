# About
    This study guide is a list of courses to prepare myself for the POSCOMP exam (Detailed sylabus at the end). Similar and more up-to-date project can be found on [OSSU](https://github.com/ossu/computer-science). 
